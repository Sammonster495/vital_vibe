...
export default function Anav(props) {
  ...
  return (
    <div
      className={`sm:px-[55px] md:px-[90px] lg:px-32 px-[20px] md:p-4 p-2 justify-between lg:flex ${
        isOpen ? "" : ""
      }`}
      id="navbar"
    >
      <Link to="/">
        <div className="flex lg:space-x-3 md:space-x-2 sm:space-x-1 space-x-0">
          <img
            ...
            alt="Vital Vibe"
            className="sm:h-[80px] md:h-[110px] lg:h-auto h-[60px]"
          />
        ...
        {props.about && (
          <div className="gradient-border">
            <li className="nav-item">
              <Link to="/about" className="mx-2.5 text-md">
                About Us
              </Link>
            </li>
          </div>
