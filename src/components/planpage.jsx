    ...
    return (
        <div>
            ...
            <div className="muscle-gain text-white font-kod h-[700px] relative p-10 pl-20 mb-10" id="muscle">
                ...
                <Link to="/predict"><button className="plans-button p-5 rounded-3xl text-xl text-black absolute left-[15%] bottom-28">CREATE PLAN</button></Link>
            </div>
            <div className="weight-loss text-white font-kod h-[700px] relative p-10 pl-20 mb-10" id="weight">
                ...
                <Link to="/plan/weightloss"><button className="plans-button p-5 rounded-3xl text-xl text-black absolute left-[15%] bottom-28">CREATE PLAN</button></Link>
            </div>
