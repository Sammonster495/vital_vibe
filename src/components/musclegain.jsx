        ...
        <div>
            ...
            <form action="" className="">
                ...
                <div className="flex flex-col">
                    ...
                    <input type="text" name="name" id="name" className="p-2 lg:px-10 md:px-8 sm:px-6 px-4 text-2xl font-kod rounded-full h-14" />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="age" className="text-white font-kod p-3">Age :</label>
                    <input type="text" name="age" id="age" className="p-2 lg:px-10 md:px-8 sm:px-6 px-4 text-2xl font-kod rounded-full h-14" />
                </div>
                <div className="flex flex-col ">
                    <label htmlFor="gender" className="text-white font-kod p-3">Gender :</label>
                    <select name="gender" id="gender" className="rounded-full h-14 lg:px-10 md:px-8 sm:px-6 px-4 font-kod text-2xl">
                        <option value=""></option>
                ...
                <div className="flex flex-col">
                    ...
                    <input type="text" name="weight" id="weight" className="p-2 lg:px-10 md:px-8 sm:px-6 px-4 text-2xl rounded-full h-14 font-kod" />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="age" className="text-white font-kod p-3">Height :</label>
                    <input type="text" name="height" id="height" className="p-2 lg:px-10 md:px-8 sm:px-6 px-4 text-2xl rounded-full h-14 font-kod" />
                </div>
                <div className="flex flex-col">
                    <label htmlFor="experience" className="text-white font-kod p-3">Experience :</label>
                    <select name="experience" id="experience" className="rounded-full h-14 lg:px-10 md:px-8 sm:px-6 px-4 text-2xl font-kod">
                        <option value=""></option>
                ...
                <button className="font-kod text-black bg-gradient-to-r from-[#74F0ED] to-[#FF7F50] h-16 w-40 my-6 rounded-lg lg:left-[43%] md:left-[42%] sm:left-[40%] left-[30%] absolute hover:scale-110">CREATE PLAN</button>
            </form>
        </div>
    );
}